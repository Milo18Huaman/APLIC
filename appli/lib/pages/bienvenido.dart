...
import 'package:appli/widgets/imagen.dart';
import 'package:appli/widgets/textoEstilizado.dart';
import 'package:appli/widgets/textoNormal.dart';
import 'package:appli/widgets/textoPersonalizado.dart';
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              imagenCircular(src: 'usuario.jpg'), 
              
              const SizedBox(height: 20), //---------------ESPACIO DE LOS CAMPOS 
              
              textoPersonalizado(texto: 'NOMBRE DE USUARIO'), 
